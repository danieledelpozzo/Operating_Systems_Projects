...
struct thread
  {
   ...
   tid_t pid;                          /* Parent's ID */
   bool beingWaited;                   /* Flag to keep track if process is currently being waited */
   bool hasExited;                     /* Flag to keep track if process has exited execution */
   int proc_status;                    /* Process status (used on exit) */
   #endif
