               ...
               thread_func *function, void *aux) 
{
  ...
  t->hasExited = false;
  t->proc_status = -1312; 
  /* -1312 := default value given for syscalls that haven't been handled yet */
  #endif
...
thread_recalculate_recent_cpu (struct thread * th, void * aux UNUSED)
{
  ...
  th->recent_cpu = FPR_MUL_FPR(part3, th->recent_cpu);   
  th->recent_cpu = FPR_ADD_INT(th->recent_cpu, th->nice);
}
